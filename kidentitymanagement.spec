...
Source0  : https://download.kde.org/stable/release-service/22.12.3/src/kidentitymanagement-22.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.3/src/kidentitymanagement-22.12.3.tar.xz.sig
...
%prep
%setup -q -n kidentitymanagement-22.12.3
cd %{_builddir}/kidentitymanagement-22.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677798330
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5IdentityManagement.so.5.22.3
/usr/lib64/libKF5IdentityManagementWidgets.so.5
/usr/lib64/libKF5IdentityManagementWidgets.so.5.22.3
