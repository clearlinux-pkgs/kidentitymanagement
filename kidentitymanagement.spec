...
Version  : 19.04.0
Release  : 8
URL      : https://download.kde.org/stable/applications/19.04.0/src/kidentitymanagement-19.04.0.tar.xz
Source0  : https://download.kde.org/stable/applications/19.04.0/src/kidentitymanagement-19.04.0.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.0/src/kidentitymanagement-19.04.0.tar.xz.sig
...
%prep
%setup -q -n kidentitymanagement-19.04.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1557015978
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
...
/usr/lib64/libKF5IdentityManagement.so.5.11.0
