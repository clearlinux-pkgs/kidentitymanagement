...
Source0  : https://download.kde.org/stable/release-service/23.04.0/src/kidentitymanagement-23.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.0/src/kidentitymanagement-23.04.0.tar.xz.sig
...
%prep
%setup -q -n kidentitymanagement-23.04.0
cd %{_builddir}/kidentitymanagement-23.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1682094784
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKPim5IdentityManagement.so.5.23.0
/usr/lib64/libKPim5IdentityManagementWidgets.so.5
/usr/lib64/libKPim5IdentityManagementWidgets.so.5.23.0
