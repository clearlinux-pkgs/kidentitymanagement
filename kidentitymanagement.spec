...
Version  : 24.12.3
Release  : 82
URL      : https://download.kde.org/stable/release-service/24.12.3/src/kidentitymanagement-24.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/kidentitymanagement-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/kidentitymanagement-24.12.3.tar.xz.sig
...
%setup -q -n kidentitymanagement-24.12.3
cd %{_builddir}/kidentitymanagement-24.12.3
pushd ..
cp -a kidentitymanagement-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742504663
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6IdentityManagementCore.so.6.3.3
/V3/usr/lib64/libKPim6IdentityManagementQuick.so.6.3.3
/V3/usr/lib64/libKPim6IdentityManagementWidgets.so.6.3.3
...
/usr/lib64/libKPim6IdentityManagementCore.so.6.3.3
/usr/lib64/libKPim6IdentityManagementQuick.so.6
/usr/lib64/libKPim6IdentityManagementQuick.so.6.3.3
/usr/lib64/libKPim6IdentityManagementWidgets.so.6
/usr/lib64/libKPim6IdentityManagementWidgets.so.6.3.3
