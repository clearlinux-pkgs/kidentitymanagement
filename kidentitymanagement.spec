...
Source0  : https://download.kde.org/stable/release-service/22.08.2/src/kidentitymanagement-22.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.2/src/kidentitymanagement-22.08.2.tar.xz.sig
...
%prep
%setup -q -n kidentitymanagement-22.08.2
cd %{_builddir}/kidentitymanagement-22.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665766134
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5IdentityManagement.so.5.21.2
/usr/lib64/libKF5IdentityManagementWidgets.so.5
/usr/lib64/libKF5IdentityManagementWidgets.so.5.21.2
