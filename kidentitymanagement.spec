...
Source0  : https://download.kde.org/stable/release-service/23.08.4/src/kidentitymanagement-23.08.4.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.4/src/kidentitymanagement-23.08.4.tar.xz.sig
...
%prep
%setup -q -n kidentitymanagement-23.08.4
cd %{_builddir}/kidentitymanagement-23.08.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702992635
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim5IdentityManagement.so.5.24.4
/V3/usr/lib64/libKPim5IdentityManagementWidgets.so.5.24.4
/usr/lib64/libKPim5IdentityManagement.so.5
/usr/lib64/libKPim5IdentityManagement.so.5.24.4
/usr/lib64/libKPim5IdentityManagementWidgets.so.5
/usr/lib64/libKPim5IdentityManagementWidgets.so.5.24.4
