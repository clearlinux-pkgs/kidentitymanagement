...
Source0  : https://download.kde.org/stable/release-service/22.04.3/src/kidentitymanagement-22.04.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.3/src/kidentitymanagement-22.04.3.tar.xz.sig
...
%prep
%setup -q -n kidentitymanagement-22.04.3
cd %{_builddir}/kidentitymanagement-22.04.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657584621
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kidentitymanagement-22.04.3/.krazy.license %{buildroot}/usr/share/package-licenses/kidentitymanagement/7ff5a7dd2c915b2b34329c892e06917c5f82f3a4
cp %{_builddir}/kidentitymanagement-22.04.3/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/kidentitymanagement/c085897bc39e05746ffd2d889a6e84ff1b7ae2d9
cp %{_builddir}/kidentitymanagement-22.04.3/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/kidentitymanagement/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/kidentitymanagement-22.04.3/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kidentitymanagement/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/kidentitymanagement-22.04.3/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kidentitymanagement/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kidentitymanagement-22.04.3/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/kidentitymanagement/6f1f675aa5f6a2bbaa573b8343044b166be28399
cp %{_builddir}/kidentitymanagement-22.04.3/metainfo.yaml.license %{buildroot}/usr/share/package-licenses/kidentitymanagement/7ff5a7dd2c915b2b34329c892e06917c5f82f3a4
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5IdentityManagement.so.5.20.3
/usr/lib64/libKF5IdentityManagementWidgets.so.5
/usr/lib64/libKF5IdentityManagementWidgets.so.5.20.3
