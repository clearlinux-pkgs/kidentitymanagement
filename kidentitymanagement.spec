...
Source0  : https://download.kde.org/stable/release-service/22.12.1/src/kidentitymanagement-22.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.1/src/kidentitymanagement-22.12.1.tar.xz.sig
...
%prep
%setup -q -n kidentitymanagement-22.12.1
cd %{_builddir}/kidentitymanagement-22.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673312745
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5IdentityManagement.so.5.22.1
/usr/lib64/libKF5IdentityManagementWidgets.so.5
/usr/lib64/libKF5IdentityManagementWidgets.so.5.22.1
