...
Source0  : https://download.kde.org/stable/applications/19.08.3/src/kidentitymanagement-19.08.3.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.3/src/kidentitymanagement-19.08.3.tar.xz.sig
...
%prep
%setup -q -n kidentitymanagement-19.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573185261
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kidentitymanagement-19.08.3/COPYING.LIB %{buildroot}/usr/share/package-licenses/kidentitymanagement/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5IdentityManagement.so.5.12.3
