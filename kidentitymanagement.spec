...
Source0  : https://download.kde.org/stable/release-service/24.12.2/src/kidentitymanagement-24.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.2/src/kidentitymanagement-24.12.2.tar.xz.sig
...
%setup -q -n kidentitymanagement-24.12.2
cd %{_builddir}/kidentitymanagement-24.12.2
pushd ..
cp -a kidentitymanagement-24.12.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738987176
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6IdentityManagementCore.so.6.3.2
/V3/usr/lib64/libKPim6IdentityManagementQuick.so.6.3.2
/V3/usr/lib64/libKPim6IdentityManagementWidgets.so.6.3.2
...
/usr/lib64/libKPim6IdentityManagementCore.so.6.3.2
/usr/lib64/libKPim6IdentityManagementQuick.so.6
/usr/lib64/libKPim6IdentityManagementQuick.so.6.3.2
/usr/lib64/libKPim6IdentityManagementWidgets.so.6
/usr/lib64/libKPim6IdentityManagementWidgets.so.6.3.2
