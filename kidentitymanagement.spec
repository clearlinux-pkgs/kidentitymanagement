...
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/kidentitymanagement-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/kidentitymanagement-24.02.0.tar.xz.sig
...
%prep
%setup -q -n kidentitymanagement-24.02.0
cd %{_builddir}/kidentitymanagement-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710421913
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6IdentityManagementCore.so.6.0.0
/V3/usr/lib64/libKPim6IdentityManagementQuick.so.6.0.0
/V3/usr/lib64/libKPim6IdentityManagementWidgets.so.6.0.0
...
/usr/lib64/libKPim6IdentityManagementCore.so.6.0.0
/usr/lib64/libKPim6IdentityManagementQuick.so.6
/usr/lib64/libKPim6IdentityManagementQuick.so.6.0.0
/usr/lib64/libKPim6IdentityManagementWidgets.so.6
/usr/lib64/libKPim6IdentityManagementWidgets.so.6.0.0
