...
Source0  : https://download.kde.org/stable/release-service/19.12.1/src/kidentitymanagement-19.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.1/src/kidentitymanagement-19.12.1.tar.xz.sig
...
%prep
%setup -q -n kidentitymanagement-19.12.1
cd %{_builddir}/kidentitymanagement-19.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578695458
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kidentitymanagement-19.12.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/kidentitymanagement/9a1929f4700d2407c70b507b3b2aaf6226a9543c
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5IdentityManagement.so.5.13.1
