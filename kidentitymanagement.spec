...
Source0  : https://download.kde.org/stable/release-service/25.04.0/src/kidentitymanagement-25.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.0/src/kidentitymanagement-25.04.0.tar.xz.sig
...
%setup -q -n kidentitymanagement-25.04.0
cd %{_builddir}/kidentitymanagement-25.04.0
pushd ..
cp -a kidentitymanagement-25.04.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744945212
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKPim6IdentityManagementCore.so.6.4.0
/V3/usr/lib64/libKPim6IdentityManagementQuick.so.6.4.0
/V3/usr/lib64/libKPim6IdentityManagementWidgets.so.6.4.0
...
/usr/lib64/libKPim6IdentityManagementCore.so.6.4.0
/usr/lib64/libKPim6IdentityManagementQuick.so.6
/usr/lib64/libKPim6IdentityManagementQuick.so.6.4.0
/usr/lib64/libKPim6IdentityManagementWidgets.so.6
/usr/lib64/libKPim6IdentityManagementWidgets.so.6.4.0
