...
Source0  : https://download.kde.org/stable/applications/19.08.2/src/kidentitymanagement-19.08.2.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.2/src/kidentitymanagement-19.08.2.tar.xz.sig
...
%prep
%setup -q -n kidentitymanagement-19.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570744330
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5IdentityManagement.so.5.12.2
