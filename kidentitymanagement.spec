...
Source0  : https://download.kde.org/stable/applications/19.08.0/src/kidentitymanagement-19.08.0.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.0/src/kidentitymanagement-19.08.0.tar.xz.sig
...
%prep
%setup -q -n kidentitymanagement-19.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1565924577
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5IdentityManagement.so.5.12.0
