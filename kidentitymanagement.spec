...
Source0  : https://download.kde.org/stable/applications/19.08.1/src/kidentitymanagement-19.08.1.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.1/src/kidentitymanagement-19.08.1.tar.xz.sig
...
%prep
%setup -q -n kidentitymanagement-19.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567741881
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF5IdentityManagement.so.5.12.1
