...
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/kidentitymanagement-21.12.0.tar.xz
...
%prep
%setup -q -n kidentitymanagement-21.12.0
cd %{_builddir}/kidentitymanagement-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639681661
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kidentitymanagement-21.12.0/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/kidentitymanagement/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/kidentitymanagement-21.12.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kidentitymanagement/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/kidentitymanagement-21.12.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kidentitymanagement/20079e8f79713dce80ab09774505773c926afa2a
cp %{_builddir}/kidentitymanagement-21.12.0/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/kidentitymanagement/6f1f675aa5f6a2bbaa573b8343044b166be28399
cp %{_builddir}/kidentitymanagement-21.12.0/metainfo.yaml.license %{buildroot}/usr/share/package-licenses/kidentitymanagement/7ff5a7dd2c915b2b34329c892e06917c5f82f3a4
pushd clr-build
%make_install
popd
...
/usr/lib64/libKF5IdentityManagement.so.5.19.0
